...
* Далее, начиная с заголовка 2 уровня описывается очередной шаг урока. (вы можете изменить ## по умолчанию на другой признак начала шага [в файле настроек](./src/settings.py) )
...
* [Примеры](https://github.com/tatyderb/stepik_deploy/blob/main/examples/step3_space.md)
...
### Тип GENNUMBER - шаг Численная задача со случайной генерацией условия


* [Численная задача со случайной генерацией условия](https://stepik.org/lesson/385343/step/1)
* [Примеры](https://github.com/tatyderb/stepik_deploy/blob/main/examples/step3_gennumber.md)
