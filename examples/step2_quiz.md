...
Варианты с кодом.<br/>
Используйте только `<pre>` или `<pre><code class="language-язык">`для обрамления кода или вставку \`\`\`. <br/>
Остальное показывается некорректно.

Какой код написан на языке С?

Этот же блок в словии показывается корректно:
...
А в вариантах - только моноширинный текст без подстветки синтаксиса и копирования.
